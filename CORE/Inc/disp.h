...
#else
#define isfenzha HAL_GPIO_ReadPin(BRK_POS_GPIO_Port, BRK_POS_Pin)

#define WF HAL_GPIO_ReadPin(EXT_TRIP_DET_GPIO_Port, EXT_TRIP_DET_Pin)
#define WH HAL_GPIO_ReadPin(EXT_CLOSE_DET_GPIO_Port, EXT_CLOSE_DET_Pin)

#define KEY1 HAL_GPIO_ReadPin(UP_BTN_GPIO_Port, UP_BTN_Pin) // 上键
#define KEY3 HAL_GPIO_ReadPin(CLOSE_BTN_GPIO_Port, CLOSE_BTN_Pin)
// #define KEY3 HAL_GPIO_ReadPin(GPIOD,GPIO_PIN_2)   //合闸
#define KEY2 HAL_GPIO_ReadPin(TEST_BTN_GPIO_Port, TEST_BTN_Pin)
#define KEY4 HAL_GPIO_ReadPin(OPEN_BTN_GPIO_Port, OPEN_BTN_Pin)     // 分闸
#define KEY5 HAL_GPIO_ReadPin(SET_BTN_GPIO_Port, SET_BTN_Pin)       // 设置键
#define KEY6 HAL_GPIO_ReadPin(CENTER_BTN_GPIO_Port, CENTER_BTN_Pin) // 确定键
#define KEY7 HAL_GPIO_ReadPin(BACK_BTN_GPIO_Port, BACK_BTN_Pin)     // 返回键
#define KEY8 HAL_GPIO_ReadPin(DOWN_BTN_GPIO_Port, DOWN_BTN_Pin)     // 向下键
// #define KEY0  GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_4)//读取按键0
// #define KEY1  GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_3)//读取按键1
// #define KEY2  GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_2)//读取按键2
// #define WK_UP   GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_0)//读取按键3(WK_UP)
