...
extern unsigned char Vol_s_T,F_C_IP,TH_Long_Cur,F_TB_trip,N_anolog_trip,F_ia,F_ip_3,F_sssj,F_cd_set,F_ip,F_cal,point_event_trip,point_event_trip_24C256,F_anolog_trip,LC_N,GZ_ph_disp,F_ch,F_gz_disp,F_al1,disp_status,D_LCur,TH_LCur,Vol_ch ,F_Special_wave;
	extern unsigned int Vol_g,Vol_q;
...
extern volatile unsigned short int I1_A_slope[2],I1_B_slope[2],I1_C_slope[2],I1_A_slope_nv[2],I1_B_slope_nv[2],I1_C_slope_nv[2];	
...
volatile  unsigned int Func_Index=0;     	unsigned char lishijilu_1[5]={0},lishijilu_bs[5]={0},lishijilu_lc[5]={0},lishijilu_oc[5]={0},lishijilu_sd[5]={0},lishijilu_2[5]={0},lishijilu_3[5]={0},guzhang_wei=0;
...
extern volatile signed long I_I_Array_xianshi[20],CurA_cal_tmp[5],CurA_cal_tmp_nv[5],CurB_cal_tmp[5],CurB_cal_tmp_nv[5],CurC_cal_tmp[5],CurC_cal_tmp_nv[5],Leak1_temp,Vol1_A_temp,Vol1_B_temp,Vol1_C_temp,Leak_temp[3];
...
extern volatile unsigned char  F_Leak_Delay,F_Disp,F_key,F_disp_tr,F_ld,F_ks,F_TB_gz,F_fz,F_hz,F_Leak_Delay1;
...
extern unsigned char F_C_IP,TH_Long_Cur,F_TB_trip,N_anolog_trip,F_ia,F_ip_3,F_sssj,F_cd_set,F_ip,F_cal,point_event_trip,point_event_trip_24C256,F_anolog_trip,LC_N,GZ_ph_disp,F_ch,F_gz_disp,F_al1,disp_status,D_LCur,TH_LCur,Vol_ch,Vol_s_T,F_Special_wave ;
extern unsigned int	Vol_g,Vol_q;
extern volatile unsigned int Leak_Cur_disp_temp,Leak_xianshi_disp;
extern volatile unsigned char Type_Cur,baud;
...
volatile unsigned char disp_status1=0,disp_gz=0 ;
volatile unsigned int SET_D_Cur=0;
...
extern unsigned char External_GateMode[3][10];
extern uint8_t External_Gate_Control_Flag;
	...
	void xianshishuju_dianliu(unsigned int dat)
{
	...
	void xianshishuju_dianya(unsigned int dat)
{
...
void shishishuju(unsigned char temp_s)
{
  ...
  HAL_RTC_GetDate(&hrtc, &sdatestructure, RTC_FORMAT_BCD);
				...
				miao[2]='\0';
				display_ASCIIstring_6x12(7,12,nian);
				display_graphic_6x12(7,24,qirigang);	
				display_ASCIIstring_6x12(7,32,yue);
				display_graphic_6x12(7,45,qirigang);	
				display_ASCIIstring_6x12(7,50,ri);
				display_ASCIIstring_6x12(7,71,shi);
				Lcd12864_Write12CnCHAR(0,82,6,":");
				display_ASCIIstring_6x12(7,89,fen);
				Lcd12864_Write12CnCHAR(0,100,6,":");
				display_ASCIIstring_6x12(7,108,miao);
			
			}
		}
		else{
		Lcd12864_Write12CnCHAR(0,0,0,"I△:        max:\r");
		xianshishuju(Leak_Cur_disp);
		display_ASCIIstring_6x12(1,30,(unsigned char*)zifu_dian);
		Lcd12864_Write12CnCHAR(0,55,0,"mA");
	 Lcd12864_Write12CnCHAR(0,0,2,"Ua:     V\rUb:     V\rUc:     V\r");
	 Lcd12864_Write12CnCHAR(0,64,2,"Ia:     A\r");
		 Lcd12864_Write12CnCHAR(0,64,4,"Ib:     A\r");
		 Lcd12864_Write12CnCHAR(0,64,6,"Ic:     A\r");
		 if (nor_disp_num_buf[4] >= nor_disp_num_buf[5]&& nor_disp_num_buf[4] >=nor_disp_num_buf[6]) {
        Lcd12864_Write12CnCHAR(0,103,0,"A");
		} else if (nor_disp_num_buf[5] >=nor_disp_num_buf[4] && nor_disp_num_buf[5]>= nor_disp_num_buf[6]) {
       Lcd12864_Write12CnCHAR(0,103,0,"B");
		} else {
       Lcd12864_Write12CnCHAR(0,103,0,"C");
		}

			xianshishuju(nor_disp_num_buf[4]);          	//电流数据
			display_ASCIIstring_6x12(3,91,zifu_dian);		
			xianshishuju(nor_disp_num_buf[5]);
			display_ASCIIstring_6x12(5,91,zifu_dian);			
			xianshishuju(nor_disp_num_buf[6]);
			display_ASCIIstring_6x12(7,91,zifu_dian);
		
		
			xianshishuju(nor_disp_num_buf[1]);

		display_ASCIIstring_6x12(3,27,zifu_dian);

		xianshishuju(nor_disp_num_buf[2]);
		display_ASCIIstring_6x12(5,27,zifu_dian);
		
		xianshishuju(nor_disp_num_buf[3]);
		display_ASCIIstring_6x12(7,27,zifu_dian);
	}
	}
	else if (temp_s==2)
	{
		...
		{	
			if(leak_f)
			{
				Lcd12864_Write12CnCHAR(0,10,0,"剩余电流超限:");
					xianshishuju(Leak_Cur_disp);
					display_ASCIIstring_6x12(1,85,(unsigned char*)zifu_dian);
				Lcd12864_Write12CnCHAR(0,110,0,"mA");
				Lcd12864_Write12CnCHAR(0,10,4,"剩余电流预警中...");
			}
//			if(F_al1)//漏电值超设定值
//			{
//				Lcd12864_Write12CnCHAR(0,10,0,"剩余电流超限:");
//					xianshishuju(Leak_Cur_disp);
//					display_ASCIIstring_6x12(1,80,(unsigned char*)zifu_dian);
//				Lcd12864_Write12CnCHAR(0,110,0,"mA");
//				Lcd12864_Write12CnCHAR(0,10,4,"剩余电流预警中...");
//			}
			else//漏电值不超设定值
			{
				 Lcd12864_Write12CnCHAR(0,20,0,"剩余电流告警运行!");
			Lcd12864_Write12CnCHAR(0,0,4," 额定电流:");
				xianshishuju_dianliu(SET_I_VAL);
		display_ASCIIstring_6x12(5,93,zifu_dian);
			}
		}
		...
		else if((isfenzha!=0)||(F_trip_ld==0))
		{
			...
			Lcd12864_Write12CnCHAR(0,38,0,"合闸运行\r");
			Lcd12864_Write12CnCHAR(0,0,4," 额定电流:");
				xianshishuju_dianliu(SET_I_VAL);
		display_ASCIIstring_6x12(5,93,zifu_dian);
		}
		
//		Lcd12864_Write12CnCHAR(0,0,0,"\r漏电延时:\r额定电流:\r");
		Lcd12864_Write12CnCHAR(0,0,0,"\r 额定剩余电流:");
		
		
		
		if(D_LCur==0)
			{
				display_ASCIIstring_6x12(3,93,"30mA");

			}
			else if(D_LCur==1)
			{
				display_ASCIIstring_6x12(3,93,"50mA");

			}
			else if(D_LCur==2)
			{
				display_ASCIIstring_6x12(3,93,"100mA");

			}
			else if(D_LCur==3)
			{
				display_ASCIIstring_6x12(3,93,"200mA");

			}
			else if(D_LCur==4)
			{
				display_ASCIIstring_6x12(3,93,"300mA");
			}
			else if(D_LCur==5)
			{
				display_ASCIIstring_6x12(3,93,"500mA");

			}
			else if(D_LCur==6)
			{
				display_ASCIIstring_6x12(3,93,"800mA");

			}
			else if(D_LCur==7)
			{
				display_ASCIIstring_6x12(3,93,"1000mA");
			}
			else if(D_LCur==8)
			{
				display_ASCIIstring_6x12(3,93,"Auto");
			}
		
//		  if(TH_LCur==0)
//			{
//				display_ASCIIstring_6x12(3,95,"0.2S");

//			}
//			else if(TH_LCur==1)
//			{
//				display_ASCIIstring_6x12(3,95,"0.3S");

//			}
//			else if(TH_LCur==2)
//			{
//				display_ASCIIstring_6x12(3,95,"0.5S");

//			}
//			else if(TH_LCur==3)
//			{
//				display_ASCIIstring_6x12(3,95,"1S");
//			}
//			else if(TH_LCur==4)
//			{
//				display_ASCIIstring_6x12(3,95,"0.1S");
//			}
  ...
  HAL_RTC_GetDate(&hrtc, &sdatestructure, RTC_FORMAT_BCD);
	...
	{
		clear_screen();
		Lcd12864_Write12CnCHAR(0,16,0,"总功率/kw");

	 Lcd12864_Write12CnCHAR(0,0,2,"Ta:     kw");
	 Lcd12864_Write12CnCHAR(0,0,4,"Tb:     kw");
	 Lcd12864_Write12CnCHAR(0,0,6,"Tc:     kw ");
		

	 xianshishuju1(nor_disp_num_buf[15]);          	//总功率数据
	 display_ASCIIstring_6x12(3,29,zifu_dian);
   display_graphic_8x16(3,53,dian);
   display_ASCIIstring_6x12(3,60,&zifu_dian[3]);
		

	 xianshishuju1(nor_disp_num_buf[16]);          	
	 display_ASCIIstring_6x12(5,29,zifu_dian);
   display_graphic_8x16(5,53,dian); 
   display_ASCIIstring_6x12(5,60,&zifu_dian[3]);
	 
	 
	 xianshishuju1(nor_disp_num_buf[17]);          	
	 display_ASCIIstring_6x12(7,29,zifu_dian);
   display_graphic_8x16(7,53,dian);	 
   display_ASCIIstring_6x12(7,60,&zifu_dian[3]);
	
	}
//	else if (temp_s==3)
//	{
//     clear_screen();
//		Lcd12864_Write12CnCHAR(0,0,0,"L1        \rA1       \rB1       \rC1       \r");
//		Lcd12864_Write12CnCHAR(0,64,2,"A2    \r");
//		Lcd12864_Write12CnCHAR(0,64,4,"B2    \r");
//		Lcd12864_Write12CnCHAR(0,64,6,"C2    \r");
//		xianshishuju(Leak1_temp);//ld
//		display_ASCIIstring_6x12(1,27,zifu_dian);
//		
//		xianshishuju(Leak_temp[0]);
//		display_ASCIIstring_6x12(3,27,zifu_dian);//A1B1C1
...
//		display_ASCIIstring_6x12(3,91,zifu_dian);//A2B2C2		
//		xianshishuju(Leak_temp[1]);
//		display_ASCIIstring_6x12(5,91,zifu_dian);			
...
//	{
//     clear_screen();
//		Lcd12864_Write12CnCHAR(0,0,0,"L2        \rKA       \rKB       \rKC       \r");
//    Lcd12864_Write12CnCHAR(0,64,2,"ka    \r");//电流实时AD值
//		Lcd12864_Write12CnCHAR(0,64,4,"kb    \r");
//		Lcd12864_Write12CnCHAR(0,64,6,"kc    \r");
//		xianshishuju(Leak1_temp);//ld
//		display_ASCIIstring_6x12(1,27,zifu_dian);
//		
//		xianshishuju(L_slope[0]);
//		display_ASCIIstring_6x12(3,27,zifu_dian);//电压AD值
...
//		display_ASCIIstring_6x12(3,91,zifu_dian);//电流实时AD值		
...
//	}
	...
	{
		clear_screen();
		Lcd12864_Write12CnCHAR(0,16,0,"有功功率/kw");

	 Lcd12864_Write12CnCHAR(0,0,2,"Pa:     kw");
	 Lcd12864_Write12CnCHAR(0,0,4,"Pb:     kw\r");
	 Lcd12864_Write12CnCHAR(0,0,6,"Pc:     kw\r");
		

	 xianshishuju1(nor_disp_num_buf[12]);          	//有功率数据
	 display_ASCIIstring_6x12(3,29,zifu_dian);//29
   display_graphic_8x16(3,53,dian);//36
   display_ASCIIstring_6x12(3,60,&zifu_dian[3]);//44
   ...
   display_ASCIIstring_6x12(7,60,&zifu_dian[3]);
	...
	{
		clear_screen();
		Lcd12864_Write12CnCHAR(0,16,0,"功率系数/P_F");

	 Lcd12864_Write12CnCHAR(0,0,2,"PFa:   ");
	 Lcd12864_Write12CnCHAR(0,0,4,"PFb:   ");
	 Lcd12864_Write12CnCHAR(0,0,6,"PFc:   ");
		
	 xianshishuju1(nor_disp_num_buf[9]);          	//功率系数数据

	 display_ASCIIstring_6x12(3,40,zifu_dian);
   display_graphic_8x16(3,47,dian);	 
   display_ASCIIstring_6x12(3,55,&zifu_dian[1]);
		
	 xianshishuju1(nor_disp_num_buf[10]);          	
	 display_ASCIIstring_6x12(5,40,zifu_dian);
   display_graphic_8x16(5,47,dian); 
   display_ASCIIstring_6x12(5,55,&zifu_dian[1]);
	 
	 xianshishuju1(nor_disp_num_buf[11]);          	
	 display_ASCIIstring_6x12(7,40,zifu_dian); 
   display_graphic_8x16(7,47,dian); 
   display_ASCIIstring_6x12(7,55,&zifu_dian[1]);
...
void long_key_process(unsigned char key_tmp)
{
		...
		{	
			...
			{
			clear_screen();
			Lcd12864_Write12CnCHAR(0,32,0,"数据校准\r\r  漏电校准:");		
			F_cal = 1;
			Cal_state = 0;
			F_sssj=3;
    	F_key=9;			
		...
		else if(key_tmp==0x80)
		{
		cui=2;	
		}
//		else if(key_tmp==0x70&&F_key!=0)
//		{
//			cui=1;
//		}
//		if(key_tmp==0x80)//档位长按下
//		{	
//			if(F_Corr==0)
//			{
//			clear_screen();
...
unsigned char  array_temp1[10];
unsigned char 	array_temp2[10];
	unsigned char 	array_temp3[10];
		unsigned int  tmp;
	int x;
...
//				{
					...
					EEPROM_R(Addr_test_num,array_temp1,3,0xA0);	
					EEPROM_R(Addr_hand_num,array_temp2,3,0xA0); 
					x=BCDtoDec(array_temp,3)+BCDtoDec(array_temp1,3)+BCDtoDec(array_temp2,3);
					DectoBCD(array_temp,x,3);
//				EEPROM_R(Addr_vol_num,array_temp,3);                    	//	闭锁跳闸次数
				generate_chuan(lishijilu_bs,array_temp[1]>>4,array_temp[1]&0x0F,array_temp[0]>>4,array_temp[0]&0x0F); 
					
				EEPROM_R(Addr_leak_num,array_temp,3,0xA0);	
//				EEPROM_R(Addr_current_num,array_temp,3);                  //漏电跳闸次数
				generate_chuan(lishijilu_lc,array_temp[1]>>4,array_temp[1]&0x0F,array_temp[0]>>4,array_temp[0]&0x0F);  
...
//				EEPROM_R(Addr_hand_num,array_temp,3);                     //电流跳闸次数
				...
				generate_chuan(lishijilu_oc,array_temp[1]>>4,array_temp[1]&0x0F,array_temp[0]>>4,array_temp[0]&0x0F);	                        //上电跳闸次数
			}
				if(key_state==0x42101){
					EEPROM_R(Addr_clear_num,array_temp,3,0xA0);                    	//	数据清零次数
				generate_chuan(lishijilu_1,array_temp[1]>>4,array_temp[1]&0x0F,array_temp[0]>>4,array_temp[0]&0x0F);
					 EEPROM_R(Addr_vol_num,array_temp,3,0xA0);	
																													//过电压跳闸次数           	//	
				generate_chuan(lishijilu_2,array_temp[1]>>4,array_temp[1]&0x0F,array_temp[0]>>4,array_temp[0]&0x0F); 	
					EEPROM_R(Addr_leakover_num,array_temp,2,0xA0);	                    //欠压
			  generate_chuan(lishijilu_bs,0,0,array_temp[0]>>4,array_temp[0]&0x0F); 	 
//					 
				EEPROM_R(Addr_leakprotect_num,array_temp,2,0xA0);                     //缺相
				generate_chuan(lishijilu_lc,0,0,array_temp[0]>>4,array_temp[0]&0x0F);
				}
				if(key_state==0x42102){
...
//				generate_chuan(lishijilu_sd,array_temp[1]>>4,array_temp[1]&0x0F,array_temp[0]>>4,array_temp[0]&0x0F); 
////				 }
				...
				if(Cal_state==2)					//电流校准100Acui  
				{
					if(((vol_handle_A(V_Array[0]))<100)&&((vol_handle_B(V_Array[1]))<100)&&((vol_handle_C(V_Array[2]))<100))  //没电压
					{
					 ...
					 if(Type_Cur==1)
						...
						CurA_cal_tmp_nv[0]=I_I_Array_xianshi[0];//I_I_Array_xianshi//I_Array_xianshi
						I_A_factor_tmp=cur_handle_A(I_I_Array_xianshi[0])-Cur_cal_tmp[0];	
						I1_A_slope_nv[0]=(Cur_cal_tmp[0]<<20)/(CurA_cal_tmp_nv[0]);//A电流校准点1
						HexToChar(array_temp,I1_A_slope_nv[0],2);
						HexToChar(array_tmp,CurA_cal_tmp_nv[0],2);
						if(Type_Cur==0)
						{
							MODIFY_EEP_W(Addr100_I1_A_slope_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr100_CurA_cal_tmp_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==1)
						{
							MODIFY_EEP_W(Addr_I1_A_slope_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr_CurA_cal_tmp_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==2)
						{
							MODIFY_EEP_W(Addr400_I1_A_slope_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr400_CurA_cal_tmp_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==3)
						{
							MODIFY_EEP_W(Addr630_I1_A_slope_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr630_CurA_cal_tmp_nv,array_tmp,2,0xA0);
						}
					  else if(Type_Cur==4)
						{
							MODIFY_EEP_W(Addr800_I1_A_slope_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr800_CurA_cal_tmp_nv,array_tmp,2,0xA0);
						}
						
						
						
						CurB_cal_tmp_nv[0]=I_I_Array_xianshi[1];
						I_B_factor_tmp=cur_handle_B(I_I_Array_xianshi[1])-Cur_cal_tmp[0];			
						I1_B_slope_nv[0]=(Cur_cal_tmp[0]<<20)/(CurB_cal_tmp_nv[0]);//B电流校准点1
						HexToChar(array_temp,I1_B_slope_nv[0],2);
						HexToChar(array_tmp,CurB_cal_tmp_nv[0],2);
						if(Type_Cur==0)
						{
							MODIFY_EEP_W(Addr100_I1_B_slope_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr100_CurB_cal_tmp_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==1)
						{
							MODIFY_EEP_W(Addr_I1_B_slope_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr_CurB_cal_tmp_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==2)
						{
							MODIFY_EEP_W(Addr400_I1_B_slope_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr400_CurB_cal_tmp_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==3)
						{
							MODIFY_EEP_W(Addr630_I1_B_slope_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr630_CurB_cal_tmp_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==4)
						{
							MODIFY_EEP_W(Addr800_I1_B_slope_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr800_CurB_cal_tmp_nv,array_tmp,2,0xA0);
						}

						
						
						CurC_cal_tmp_nv[0]=I_I_Array_xianshi[2];
						I_C_factor_tmp=cur_handle_C(I_I_Array_xianshi[2])-Cur_cal_tmp[0];					
						I1_C_slope_nv[0]=(Cur_cal_tmp[0]<<20)/(CurC_cal_tmp_nv[0]);//C电流校准点1
						HexToChar(array_temp,I1_C_slope_nv[0],2);
						HexToChar(array_tmp,CurC_cal_tmp_nv[0],2);
						if(Type_Cur==0)
						{
							MODIFY_EEP_W(Addr100_I1_C_slope_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr100_CurC_cal_tmp_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==1)
						{
							MODIFY_EEP_W(Addr_I1_C_slope_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr_CurC_cal_tmp_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==2)
						{
							MODIFY_EEP_W(Addr400_I1_C_slope_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr400_CurC_cal_tmp_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==3)
						{
							MODIFY_EEP_W(Addr630_I1_C_slope_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr630_CurC_cal_tmp_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==4)
						{
							MODIFY_EEP_W(Addr800_I1_C_slope_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr800_CurC_cal_tmp_nv,array_tmp,2,0xA0);
						}
				...
				if(Cal_state==3)
				{
					if(((vol_handle_A(V_Array[0]))<100)&&((vol_handle_B(V_Array[1]))<100)&&((vol_handle_C(V_Array[2]))<100))  //没电压
					{
					 ...
					 if(Type_Cur==1)
						...
						CurA_cal_tmp_nv[1]=I_I_Array_xianshi[0];
						I_A_factor_tmp=cur_handle_A(I_I_Array_xianshi[0])-Cur_cal_tmp[1];	
						I1_A_slope_nv[1]=((Cur_cal_tmp[1]-Cur_cal_tmp[0])<<20)/(CurA_cal_tmp_nv[1]-CurA_cal_tmp_nv[0]);//a电流校准点2
						HexToChar(array_temp,I1_A_slope_nv[1],2);
						HexToChar(array_tmp,CurA_cal_tmp_nv[1],2);
						if(Type_Cur==0)
						{
							MODIFY_EEP_W(Addr100_I1_A_slope1_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr100_CurA_cal_tmp1_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==1)
						{
							MODIFY_EEP_W(Addr_I1_A_slope1_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr_CurA_cal_tmp1_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==2)
						{
							MODIFY_EEP_W(Addr400_I1_A_slope1_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr400_CurA_cal_tmp1_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==3)
						{
							MODIFY_EEP_W(Addr630_I1_A_slope1_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr630_CurA_cal_tmp1_nv,array_tmp,2,0xA0);
						}
												else if(Type_Cur==4)
						{
							MODIFY_EEP_W(Addr800_I1_A_slope1_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr800_CurA_cal_tmp1_nv,array_tmp,2,0xA0);
						}
						
						
						
						CurB_cal_tmp_nv[1]=I_I_Array_xianshi[1];
						I_B_factor_tmp=cur_handle_B(I_I_Array_xianshi[1])-Cur_cal_tmp[1];			
						I1_B_slope_nv[1]=((Cur_cal_tmp[1]-Cur_cal_tmp[0])<<20)/(CurB_cal_tmp_nv[1]-CurB_cal_tmp_nv[0]);//b电流校准点2
						HexToChar(array_temp,I1_B_slope_nv[1],2);
						HexToChar(array_tmp,CurB_cal_tmp_nv[1],2);
						if(Type_Cur==0)
						{
							MODIFY_EEP_W(Addr100_I1_B_slope1_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr100_CurB_cal_tmp1_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==1)
						{
							MODIFY_EEP_W(Addr_I1_B_slope1_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr_CurB_cal_tmp1_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==2)
						{
							MODIFY_EEP_W(Addr400_I1_B_slope1_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr400_CurB_cal_tmp1_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==3)
						{
							MODIFY_EEP_W(Addr630_I1_B_slope1_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr630_CurB_cal_tmp1_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==4)
						{
							MODIFY_EEP_W(Addr800_I1_B_slope1_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr800_CurB_cal_tmp1_nv,array_tmp,2,0xA0);
						}
						
						
						
						CurC_cal_tmp_nv[1]=I_I_Array_xianshi[2];
						I_C_factor_tmp=cur_handle_C(I_I_Array_xianshi[2])-Cur_cal_tmp[1];					
						I1_C_slope_nv[1]=((Cur_cal_tmp[1]-Cur_cal_tmp[0])<<20)/(CurC_cal_tmp_nv[1]-CurC_cal_tmp_nv[0]);//c电流校准点2
						HexToChar(array_temp,I1_C_slope_nv[1],2);
						HexToChar(array_tmp,CurC_cal_tmp_nv[1],2);
						if(Type_Cur==0)
						{
							MODIFY_EEP_W(Addr100_I1_C_slope1_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr100_CurC_cal_tmp1_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==1)
						{
							MODIFY_EEP_W(Addr_I1_C_slope1_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr_CurC_cal_tmp1_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==2)
						{
							MODIFY_EEP_W(Addr400_I1_C_slope1_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr400_CurC_cal_tmp1_nv,array_tmp,2,0xA0);
						}
						else if(Type_Cur==3)
						{
							MODIFY_EEP_W(Addr630_I1_C_slope1_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr630_CurC_cal_tmp1_nv,array_tmp,2,0xA0);
						}
												else if(Type_Cur==4)
						{
							MODIFY_EEP_W(Addr800_I1_C_slope1_nv,array_temp,2,0xA0);
							MODIFY_EEP_W(Addr800_CurC_cal_tmp1_nv,array_tmp,2,0xA0);
						}
						F_cIcal_err=0;
						F_cal_finish=1;
					}
...
/*************************************************/
		...
		if((key==0x20)&&(F_gz_disp!=0x0f))//确定键
		{
			...
			//F_gz_disp = 0x0F;cui7.24实现 不显示停电
			F_Disp = 1 ;
			F_key=0 ;
			disp_status = 0;
			Func_Index=0;
      ...
      if(key==0x80)//向下键
			 {
					         ...
					         tiaozheng_key_state(0x11100,17,1);         //漏电告警：   0：关，1：开
									  ...
									  tiaozheng_key_state(0x21100,9,0);					//额定漏电： 0.05A,0.1A,0.3A,0.5A,0.8A,1A,AUTO
...
//					 tiaozheng_key_state(0x24100,2,1);               //欠压保护
					 ...
					 tiaozheng_key_state(0x24100,0x33,0);               //欠压档位
...
//					 tiaozheng_key_state(0x39100,2,1);               //电流重合闸
					 ...
					 tiaozheng_key_state(0x42100,3,1);               //跳闸次数
...
//					 tiaozheng_key_state(0x75100,2,1);
					...
					tiaozheng_key_state(0x80100,3,0);
				}
			 ...
			 if(key==0x01)//向上键
			 {
					 	tiaozheng_key_state(0x11100,15,0);         //漏电告警：   0：关，1：开
									  ...
									  tiaozheng_key_state(0x21100,9,1);					//额定漏电： 0.05A,0.1A,0.3A,0.5A,0.8A,1A,AUTO
...
//					 tiaozheng_key_state(0x24100,2,0);               //欠压保护
					 ...
					 tiaozheng_key_state(0x24100,0x33,1);               //欠压档位
							 if(Type_Cur_change=1)
						 {
...
//					 tiaozheng_key_state(0x39100,2,0);               //电流重合闸
					 ...
					 tiaozheng_key_state(0x42100,3,0);               //跳闸次数
           ...
           tiaozheng_key_state(0x2A100,5,1);    //壳架等级
					 ...
					 tiaozheng_key_state(0x80100,3,1);
				}
//////////	     //返回
//////////       if(key==0x40)
//////////        {
...
unsigned char abnormal_disp(void)
{
    ...
    if(F_disp_jg==0x55)
    {
			...
			clear_screen();
			Lcd12864_Write12CnCHAR(0,32,0,"合闸失败");
        return 0 ;
    }
    //如果脱扣不成功
    if(F_disp_tr==1)
    {
			...
			clear_screen();
			Lcd12864_Write12CnCHAR(0,32,0,"分闸失败");
        return 0 ;
    }
		return 1;
}
...
//	{
//			clear_screen();
//			Lcd12864_Write12CnCHAR(0,16,3,"合闸失败...");
//			return 0;		
//	}
//	//如果脱扣不成功
//	if(F_disp_tr==1)
...
//	return 1;
//}
extern unsigned char time_disp[5];
unsigned char guzhang_disp(void)
{
	//如果在合闸状态
    if(isfenzha!=0)
...
//							Lcd12864_Write12CnCHAR(0,0,4," 重合闸次数:");
//							xianshishuju(F_ch);
//							display_ASCIIstring_6x12(5,110,zifu_dian);

//							Lcd12864_Write12CnCHAR(0,0,6," 欠压档位:");
//							
//								xianshishuju_dianya(140+Vol_q);
//							display_ASCIIstring_6x12(7,88,zifu_dian);
...
//							
//							display_ASCIIstring_6x12(5,110,zifu_dian);
//							Lcd12864_Write12CnCHAR(0,0,6," 额定漏电:");
//							display_ASCIIstring_6x12(7,88,dianliu1[D_LCur]);
							
							
            }
            //过流“GL”
            if((F_gz_disp==N_gl)||(F_gz_disp==C_gl)||(F_gz_disp==B_gl)||(F_gz_disp==A_gl))
            {
                ...
                gz_disp1=SET_I_VAL ;
					...
					Lcd12864_Write12CnCHAR(0,70,4,"相别:");
							...
							//display_ASCIIstring_6x12(7,92,zifu_dian);    //电流保存
            }
            //停电“tD”
            if(F_gz_disp==Gz_TD)
            {
...
//				Lcd12864_Write12CnCHAR(0,32,2,"未知");
            ...
            if(F_gz_disp==Gz_QL)
            {
				...
				nian[0]=(time_disp[0]>>4)+0x30;				
				nian[1]=(time_disp[0]&0x0F)+0x30;	
				nian[2]='\0';
	
				yue[0]=(time_disp[1]>>4)+0x30;
				yue[1]=(time_disp[1]&0x0F)+0x30;
				yue[2]='\0';

				ri[0]=(time_disp[2]>>4)+0x30;
				ri[1]=(time_disp[2]&0x0F)+0x30;
				ri[2]='\0';

				shi[0]=(time_disp[3]>>4)+0x30;
				shi[1]=(time_disp[3]&0x0F)+0x30;
				shi[2]='\0';

				fen[0]=(time_disp[4]>>4)+0x30;
				fen[1]=(time_disp[4]&0x0F)+0x30;
				fen[2]='\0';
				
				miao[0]=(time_disp[5]>>4)+0x30;
				miao[1]=(time_disp[5]&0x0F)+0x30;
				miao[2]='\0';
				display_ASCIIstring_6x12(7,12,nian);
				display_graphic_6x12(7,24,qirigang);	
				display_ASCIIstring_6x12(7,32,yue);
	 ...
	 unsigned char array_tmp[2];
		...
		if(++disp_status1>=2)
		{
			...
			if(Func_Index==59)
			{
					...
					{
						display_ASCIIstring_6x12(1,5,"TestVer.");
						Lcd12864_Write12CnCHAR(0,65,0,"电流\rIa:   A Ib:   A\rIc:   A In:   A\r 过载档位:    A");
					}
					
#else
					Lcd12864_Write12CnCHAR(0,32,0,"实时电流\rIa:   A Ib:   A\rIc:   A In:   A\r 过载档位:    A");
#endif
					...
					display_ASCIIstring_6x12(7,84,zifu_dian);    
...
//					Func_Index++;
			...
			else if(Func_Index==60)
			{
					...
					clear_screen();
						...
						{				
						display_ASCIIstring_6x12(1,5,"TestVer.");
						Lcd12864_Write12CnCHAR(0,65,0,"电压\rUa:   V Ub:   V\rUc:   V Un:   V\r过:     欠:");
					}
#else
					Lcd12864_Write12CnCHAR(0,32,0,"实时电压\rUa:   V Ub:   V\rUc:   V Un:   V\r过:     欠:");
#endif					
					xianshishuju(nor_disp_num_buf[1]);
					display_ASCIIstring_6x12(3,27,zifu_dian);
					xianshishuju(nor_disp_num_buf[2]);
					...
					xianshishuju(nor_disp_num_buf[3]);
					display_ASCIIstring_6x12(5,27,zifu_dian);
					display_ASCIIstring_6x12(7,28,DIANYA[Vol_g]);
					display_ASCIIstring_6x12(7,91,DIANYA_1[Vol_q]);
//					Func_Index++;
		 }
          ...
          if((F_trip_ld)&&(F_al1))
					{				
						...
						Lcd12864_Write12CnCHAR(0,65,0,"\r\r额定漏电:    \r分断时间:    ");
//							xianshishuju(nor_disp_num_buf[0]);
					display_ASCIIstring_6x12(5,78,dianliu[D_LCur]);
					display_ASCIIstring_6x12(7,78,shijian[TH_LCur]);
					}
					else
					{
#ifdef 			F_vison	
						{						
						display_ASCIIstring_6x12(1,5,"TestVer.");
						Lcd12864_Write12CnCHAR(0,65,0,"剩余电流\r实时漏电:     mA\r额定漏电:    \r分断时间:    ");
					}
#else
						Lcd12864_Write12CnCHAR(0,16,0,"实时剩余电流\r实时漏电:     mA\r额定漏电:    \r分断时间:    ");
#endif		
					xianshishuju(nor_disp_num_buf[0]);
					clear_define_screen(2,4,92,108);
					display_ASCIIstring_6x12(3,78,zifu_dian);
					display_ASCIIstring_6x12(5,78,dianliu[D_LCur]);
					display_ASCIIstring_6x12(7,78,shijian[TH_LCur]);
					}
...
//		}
			clear_screen();
			Lcd12864_Write12CnCHAR(0,16,3,"正在分闸...");
			return 0;		
	}
//	if(F_disp_jg==0x55)
//	{
...
//			shishishuju(1);
	...
	if((F_cal==1)&&(F_sssj==3))               //校准界面
	{
		...
		if(Cal_state==0)	//漏电校准
		{
			if(F_L_err==0)
			{
			   ...
			   clear_screen();
				...
				if(F_cal_finish==1)
				{
					display_ASCIIstring_6x12_with_underline(5,84,zifu_dian);
				}
				else
				{
					display_ASCIIstring_6x12(5,84,zifu_dian);
				}
			...
			if(Cal_state==1)	//电压+
		{
     		...
     		clear_screen();
				Lcd12864_Write12CnCHAR(0,32,0,"电压校准: \r  A 相电压:      V\r  B 相电压:      V\r  C 相电压:      V");
				
				if(F_cal_finish==1)
				{

					xianshishuju(nor_disp_num_buf[1]);
					display_ASCIIstring_6x12_with_underline(3,84,zifu_dian);

					xianshishuju(nor_disp_num_buf[2]);
					display_ASCIIstring_6x12_with_underline(5,84,zifu_dian);

					xianshishuju(nor_disp_num_buf[3]);
					display_ASCIIstring_6x12_with_underline(7,84,zifu_dian);
				...
				else
				{
					...
					xianshishuju(nor_disp_num_buf[1]);
					display_ASCIIstring_6x12(3,84,zifu_dian);
		  ...
		  if(Cal_state==2)	//电流100
		{
         ...
         clear_screen();
				if(Type_Cur==0)
				{
					Lcd12864_Write12CnCHAR(0,16,0,"50A电流校准: \r  A 相电流:      A\r  B 相电流:      A\r  C 相电流:      A");
																													      
				}                                                                                                         
																													      
			 else if(Type_Cur==1)                                                                                         
				{                                                                                                         
					Lcd12864_Write12CnCHAR(0,16,0,"100A电流校准: \r  A 相电流:      A\r  B 相电流:      A\r  C 相电流:      A");
																													      
				}                                                                                                         
			 else if(Type_Cur==2)                                                                                         
				{                                                                                                         
					Lcd12864_Write12CnCHAR(0,16,0,"160A电流校准: \r  A 相电流:      A\r  B 相电流:      A\r  C 相电流:      A");
				}                                                                                                         
				else if(Type_Cur==3)                                                                                      
				{                                                                                                         
					Lcd12864_Write12CnCHAR(0,16,0,"252A电流校准: \r  A 相电流:      A\r  B 相电流:      A\r  C 相电流:      A");
				}                                                                                                         
				else if(Type_Cur==4)                                                                                      
				{                                                                                                         
					Lcd12864_Write12CnCHAR(0,16,0,"320A电流校准: \r  A 相电流:      A\r  B 相电流:      A\r  C 相电流:      A");
				}
        ...
        F_cal_finish=0;
				...
				if(Cal_state==3)	//电流250
		 {
          ...
          clear_screen();
			 	if(Type_Cur==0)
				{
					Lcd12864_Write12CnCHAR(0,16,0,"125A电流校准: \r  A 相电流:      A\r  B 相电流:      A\r  C 相电流:      A");
																													     
				}                                                                                                          
			 else if(Type_Cur==1)                                                                                          
				{                                                                                                          
					Lcd12864_Write12CnCHAR(0,16,0,"250A电流校准: \r  A 相电流:      A\r  B 相电流:      A\r  C 相电流:      A");
																													     
				}                                                                                                          
			 else if(Type_Cur==2)                                                                                          
				{                                                                                                          
					Lcd12864_Write12CnCHAR(0,16,0,"400A电流校准: \r  A 相电流:      A\r  B 相电流:      A\r  C 相电流:      A");
				}                                                                                                          
			 else if(Type_Cur==3)                                                                                          
				{                                                                                                          
					Lcd12864_Write12CnCHAR(0,16,0,"630A电流校准: \r  A 相电流:      A\r  B 相电流:      A\r  C 相电流:      A");
				}                                                                                                          
				else if(Type_Cur==4)                                                                                       
				{                                                                                                          
					Lcd12864_Write12CnCHAR(0,16,0,"800A电流校准: \r  A 相电流:      A\r  B 相电流:      A\r  C 相电流:      A");
				}
				if(F_cal_finish==1)
				{
...
//					xianshishuju(cur_handle_A(I_I_Array_xianshi[2]));
 		...
 		if(F_sssj==10)//通信校准页面//YJK
		{
			  LEDA_ON;
				clear_screen();
				Lcd12864_Write12CnCHAR(0,0,0,"时间");
			  Lcd12864_Write12CnCHAR(0,0,2,"电压");
			  Lcd12864_Write12CnCHAR(0,0,4,"漏电");
			  Lcd12864_Write12CnCHAR(0,0,6,"电流");
        ...
        HAL_RTC_GetDate(&hrtc, &sdatestructure, RTC_FORMAT_BCD);
				...
				miao[1]=(stimestructure.Seconds&0x0F)+0x30;
				miao[2]='\0';
//				display_ASCIIstring_6x12(7,8,nian);
//				display_graphic_8x16(7,24,qirigang);	
				display_ASCIIstring_6x12(1,36,yue);
//				display_graphic_8x16(7,45,qirigang);	
				display_ASCIIstring_6x12(1,52,ri);
				
//				display_graphic_8x16(1,65,xiaogang);	
				display_ASCIIstring_6x12(1,71,shi);
				display_graphic_8x16(1,87,xiaomaohao);	
				display_ASCIIstring_6x12(1,92,fen);
				display_graphic_8x16(1,108,xiaomaohao);	
				display_ASCIIstring_6x12(1,113,miao);
				}
			  ...
			  if(TXJZ_DY_A==1)//a电压
				 ...
				 if(TXJZ_DY_B==1)//B电压
				{
					...
					display_ASCIIstring_6x12(3,70,zifu_dian);
				}
				
				 if(TXJZ_DY_C==1)//c电压
				{
					xianshishuju(nor_disp_num_buf[3]);//C
					display_ASCIIstring_6x12(3,100,zifu_dian);
				}
			  ...
			  if(TXJZ_DL_A==1)//A电流
				...
				if(TXJZ_DL_B==1)//B电流
				{
					...
					display_ASCIIstring_6x12(7,70,zifu_dian);
				}
				
				if(TXJZ_DL_C==1)//C电流
				{
					xianshishuju(nor_disp_num_buf[6]); //C
					display_ASCIIstring_6x12(7,100,zifu_dian);
				}
...
//	int shuzi,weizhi,i\\
	...
	Lcd12864_Write12CnCHAR(0,3,2,"请输入密码:");
	weizhi=(key_state >> 16)&0x0f;//第几位密码


	
//	draw_horizontal_line(44, 62, 66);
	
		if(weizhi==0)
	{
	  mima[0]=((key_state>>12)&0x0000000f);//输入的密码值	
		//Lcd12864_Write16CnCHAR(0,32,4,"杠");
		//Lcd12864_Write12CnCHAR(0,62,5,"杠");
		draw_horizontal_line(48, 62, 66);
	}

	else if(weizhi==1)
	{
	  mima[1]=((key_state>>8)&0x0000000f);	
//		Lcd12864_Write12CnCHAR(0,68,5,"杠");//显示选中的线
		draw_horizontal_line(48, 68, 72);
	}
	else if(weizhi==2)
	{
	 mima[2]=((key_state>>4)&0x0000000f);
//		Lcd12864_Write12CnCHAR(0,74,5,"杠");
		draw_horizontal_line(48, 74, 78);
	}
	else if(weizhi==3)
	{
	   mima[3]=key_state&0x0000000f;	
//		Lcd12864_Write12CnCHAR(0,80,5,"杠");
		draw_horizontal_line(48, 80, 84);
	}
		xianshishuju(mima[0]);
	  Lcd12864_Write12CnCHAR(0,62,4,zifu_dian);
		xianshishuju(mima[1]);
	  Lcd12864_Write12CnCHAR(0,68,4,zifu_dian);	
		xianshishuju(mima[2]);
	  Lcd12864_Write12CnCHAR(0,74,4,zifu_dian);
		xianshishuju(mima[3]);
	  Lcd12864_Write12CnCHAR(0,80,4,zifu_dian);
}
...
void mima_check()//把输入的密码与设定的密码进行比对//杨济恺2022.2.21
{
   ...
   if((mima[0]==mima_set[0])&&(mima[1]==mima_set[1])&&(mima[2]==mima_set[2])&&(mima[3]==mima_set[3]))
	 {
		 clear_screen();
	   Lcd12864_Write12CnCHAR(0,33,2,"密码正确");
	 ...
	 {
	   clear_screen();
	   Lcd12864_Write12CnCHAR(0,33,2,"密码错误");
		 HAL_Delay(800);
...
extern unsigned char hezha_delay_show[10][4];
...
void mima_change()//修改密码//杨济恺2022.2.23
{
    ...
    clear_screen();       
   Lcd12864_Write12CnCHAR(0, 0, 0, " 合闸延时:\r 修改密码:\r 通信地址:\r 短接模式:");
		Lcd12864_Write12CnCHAR(0,0,2,">");
...
display_ASCIIstring_6x12(3,96,mima0);
display_ASCIIstring_6x12(3,104,mima1);
display_ASCIIstring_6x12(3,112,mima2);
display_ASCIIstring_6x12(3,120,mima3);
		    Lcd12864_Write12CnCHAR(0,76, 6, External_GateMode[External_Gate_Control_Flag]);
	if(((key_state >> 16)&0x0f)==0)
	{
	    mima[0]=((key_state>>12)&0x0000000f);//输入的密码值	
		mima0[0]=mima[0]+0x30;
		mima0[1]='\0';
		display_ASCIIstring_6x12_with_underline(3,96,mima0);
	}
	...
	else if(((key_state >> 16)&0x0f)==1)
	{
	  ...
	  mima[1]=((key_state>>8)&0x0000000f);	
		mima1[0]=mima[1]+0x30;
		mima1[1]='\0';
		display_ASCIIstring_6x12_with_underline(3,104,mima1);
	}
	else if(((key_state >> 16)&0x0f)==2)
	{
	  mima[2]=((key_state>>4)&0x0000000f);
		mima2[0]=mima[2]+0x30;
		mima2[1]='\0';
		display_ASCIIstring_6x12_with_underline(3,112,mima2);
	...
	else if(((key_state >> 16)&0x0f)==3)
	{
	  mima[3]=key_state&0x0000000f;	
		mima3[0]=mima[3]+0x30;
		mima3[1]='\0';
		display_ASCIIstring_6x12_with_underline(3,120,mima3);
		
	}
		

//	 Lcd12864_Write12CnCHAR(0,0,3,"19通信地址\r");
		 add_1_2[0]=(self_addr_code[0]&0x0F)+0x30;
	      ...
	      add_6_1[0]=(self_addr_code[5]>>4)+0x30;
	            ...
	            display_ASCIIstring_6x12(5,56,add_6_1);
				display_ASCIIstring_6x12(5,62,add_6_2);			
				display_ASCIIstring_6x12(5,68,add_5_1);
				display_ASCIIstring_6x12(5,74,add_5_2);			
				display_ASCIIstring_6x12(5,80,add_4_1);
				display_ASCIIstring_6x12(5,86,add_4_2);							
				display_ASCIIstring_6x12(5,92,add_3_1);
				display_ASCIIstring_6x12(5,98,add_3_2);	
				display_ASCIIstring_6x12(5,104,add_2_1);
				display_ASCIIstring_6x12(5,110,add_2_2);		
				display_ASCIIstring_6x12(5,116,add_1_1);				
				display_ASCIIstring_6x12(5,122,add_1_2);
 display_ASCIIstring_6x12_right_align(1,127,hezha_delay_show[TH_hezha_delay]);
}
