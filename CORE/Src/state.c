...
extern volatile unsigned char F_Leak_Delay, F_Leak_Delay1;
...
extern unsigned char F_TIME, T_W, V_point, Vol_s_T, Vol_up, Vol_down; // 失过欠压保护时间档位指针
extern unsigned int Vol_g_T, Vol_q_T;
extern unsigned char Type_Cur, D_M_Cur, D_I2, D_S; // 过载保护规格,档位长度,档位指针
extern unsigned int D_Cur;
extern unsigned char F_Cur, iii, F_ip, F_cd_set, F_ia, N_anolog_trip, F_I_STA, F_I_Lock;
extern unsigned char lishijilu_1[5], lishijilu_2[5], lishijilu_3[5], guzhang_wei, lishijilu_bs[5], lishijilu_lc[5], lishijilu_oc[5];
...
extern unsigned char disp_status1, disp_gz;
extern unsigned int SET_D_Cur;
...
extern void xianshishuju_dianya(unsigned int dat);
...
extern unsigned char mima0[2], mima1[2], mima2[2], mima3[2];
unsigned char Type_Cur_temp, Type_Cur_change = 1;
...
unsigned int dianliu11[9] =
    {
        1000, 1000, 1000, 1000, 50, 70, 70, 70, 70};
...
// unsigned char External_GateMode[3][10]=
//{
//	"常规","短接分闸","短接合闸"
//};
...
void Disp_date(void)
{
    Lcd12864_Write12CnCHAR(0, 0, 4, " 日期:");
    ...
    nian_qian[2] = '\0';
    display_ASCIIstring_6x12(5, 64, nian_qian);
    display_ASCIIstring_6x12(5, 76, nian);
    display_graphic_6x12(5, 87, qirigang);
    display_ASCIIstring_6x12(5, 96, yue);
    display_graphic_6x12(5, 108, qirigang);
    display_ASCIIstring_6x12(5, 113, ri);
}

void Disp_time(void)
{
    Lcd12864_Write12CnCHAR(0, 0, 6, " 时间:");
    ...
    nian_qian[1] = 0x00 + 0x30;
    nian_qian[2] = '\0';
    //				display_graphic_8x16(7,65,qirigang);
...
{
    //	  Lcd12864_Write12CnCHAR(0,32,0,"时间设置\r");
    //	   Lcd12864_Write12CnCHAR(0,32,3,"年  月  日\r");
    //	   Lcd12864_Write12CnCHAR(0,32,6,"时  分  秒\r");
    //	  display_xianfangkuai(3,5,0,0);
...
{
    clear_screen(); // 清屏
    Lcd12864_Write12CnCHAR(0, 16, 0, "1漏电设置\r  2电压设置\r  3电流设置\r  4记录查询");
...
void Fun_GJ() // 漏电告警
{
    ...
    clear_screen();
    Lcd12864_Write12CnCHAR(0, 6, 0, "1.剩余电流保护\r 2.自动定档\r 3.突变保护\r 4.特波保护");
    display_graphic_6x12(1, 91, maohao);
    display_graphic_6x12(3, 67, maohao);
    display_graphic_6x12(5, 67, maohao);
    display_graphic_6x12(7, 67, maohao);
    Lcd12864_Write12CnCHAR(0, 0, 0, ">");
    //   display_sanjiao(1,119,0,1);

    //   display_kaiguan_frame(1,83,F_trip_ld);
    display_kaiguan(1, 103, !F_trip_ld);
    display_kaiguan(3, 103, F_auto_ld);
    display_kaiguan(5, 103, F_TB_trip);
    display_kaiguan(7, 103, F_Special_wave);
...
void Fun_FZ() // 漏电阀值
{
    unsigned char array_tmp[3];
    clear_screen();
    Lcd12864_Write12CnCHAR(0, 0, 0, " 额定剩余电流:\r 不驱动时间:\r 过电压阈值:\r 欠电压阈值:");

    Lcd12864_Write12CnCHAR(0, 0, 0, ">");
    xianshishuju_dianya(250 + Vol_g);

    display_ASCIIstring_6x12_right_align(1, 127, dianliu[D_LCur]);
    display_ASCIIstring_6x12_right_align(3, 127, shijian[TH_LCur]);
    display_ASCIIstring_6x12_right_align(5, 127, zifu_dian);
    xianshishuju_dianya(140 + Vol_q);
    display_ASCIIstring_6x12_right_align(7, 127, zifu_dian);
    if (F_queren == 1)
    {
    ...
    display_ASCIIstring_6x12_right_align(1, 127, dianliu[(key_state & 0xFF)]);
    if ((key_value_tmp == 0x20) && (F_queren == 3))
    {
...
void Fun_YS() // 漏电延时
{
    ...
    clear_define_screen(2, 4, 82, 128);
    display_ASCIIstring_6x12_right_align(3, 127, shijian[(key_state & 0xFF)]);
    if ((key_value_tmp == 0x20) && (F_queren == 3))
    {
...
{
    clear_screen();
    Lcd12864_Write12CnCHAR(0, 0, 0, "1.漏电告警\r2.漏电阀值\r3.漏电延时\r4.漏电重合");
    display_graphic_6x12(1, 77, maohao);
    display_graphic_6x12(3, 77, maohao);
    display_graphic_6x12(5, 77, maohao);
    display_graphic_6x12(7, 77, maohao);
    //  display_sanjiao(1,119,0,1);
    display_kaiguan(1, 83, F_trip_ld);
    //	  Lcd12864_Write12CnCHAR(0,78,0,kaiguan[F_trip_ld]);
    display_ASCIIstring_8x16(3, 83, dianliu[D_LCur]);
    display_ASCIIstring_8x16(5, 83, shijian[TH_LCur]);
    //		Lcd12864_Write12CnCHAR(0,78,6,kaiguan[F_TB_trip]);
...
{
    clear_screen();
    Lcd12864_Write12CnCHAR(0, 0, 0, "5突变保护\r6漏电监测");
    display_graphic_6x12(1, 77, maohao);
    display_graphic_6x12(3, 77, maohao);
...
void Fun_DY()
{
    ...
    {
        clear_screen();
        Lcd12864_Write12CnCHAR(0, 16, 0, "1.漏电设置\r  2.电压设置\r  3.电流设置\r  4.记录查询");
    }
    else
    {
...
void Fun_SY() // 全失压保护
{
    unsigned char array_tmp[3];
    clear_screen();
    Lcd12864_Write12CnCHAR(0, 0, 0, " 9.全失压保护\r A.过载保护\r B.短延保护\r C.瞬时保护");
    display_graphic_6x12(1, 79, maohao);
    display_graphic_6x12(3, 67, maohao);
    display_graphic_6x12(5, 67, maohao);
    display_graphic_6x12(7, 67, maohao);
    Lcd12864_Write12CnCHAR(0, 0, 0, ">");
    //	  display_sanjiao(1,119,0,1);
    display_kaiguan(1, 103, F_trip_sy);
    display_kaiguan(3, 103, F_trip_gl);
    display_kaiguan(5, 103, F_ip);
    display_kaiguan(7, 103, F_ip_3);
...
void Fun_QX() // 缺相保护
{
    ...
    Lcd12864_Write12CnCHAR(0, 0, 0, " 5.缺零保护\r 6.过电压保护\r 7.欠电压保护\r 8.断相保护");
    display_graphic_6x12(1, 67, maohao);
    display_graphic_6x12(3, 79, maohao);
    display_graphic_6x12(5, 79, maohao);
    display_graphic_6x12(7, 67, maohao);
    Lcd12864_Write12CnCHAR(0, 0, 6, ">");
    //	  display_sanjiao(1,119,0,1);
    display_kaiguan(1, 103, F_trip_QL);
    display_kaiguan(3, 103, F_trip_gy);
    display_kaiguan(5, 103, F_trip_qy);
    display_kaiguan(7, 103, F_trip_QX);
...
void Fun_GY_Val() // 过压档位
{
    ...
    Vol_g = key_state - 0x23100;
    xianshishuju_dianya(250 + Vol_g);
    clear_define_screen(4, 6, 83, 128);
    xianshishuju_dianya(250 + Vol_g);
    display_ASCIIstring_6x12_right_align(5, 127, zifu_dian);
    if ((key_value_tmp == 0x20) && (F_queren == 3))
    {
        ...
        clear_define_screen(4, 6, 82, 128);
        //	  display_ASCIIstring_6x12_right_align(5,83,shijian[Vol_g]);
        xianshishuju_dianya(250 + Vol_g);
        display_ASCIIstring_6x12_right_align(5, 127, zifu_dian);
        key_state = 0x24100;
        F_queren = 1;
...
void Fun_QY_Val() // 欠压档位
{
    ...
    Vol_q = key_state - 0x24100;
    xianshishuju_dianya(140 + Vol_q);
    clear_define_screen(6, 8, 83, 128);
    display_ASCIIstring_6x12_right_align(7, 127, zifu_dian);
    if ((key_value_tmp == 0x20) && (F_queren == 3))
    {
        Vol_q = key_state - 0x24100;
...
void Fun_ST() // 失压延时
{
    clear_screen();
    unsigned char array_tmp[3];
    Lcd12864_Write12CnCHAR(0, 0, 0, " 失压延时时间:\r 过压延时时间:\r 欠压延时时间:\r 瞬时倍数:");

    //	  display_sanjiao(1,119,0,1);
    display_ASCIIstring_6x12_right_align(1, 127, SY_yanshi[D_SY_yanshi]);
    display_ASCIIstring_6x12_right_align(3, 127, GY_yanshi[D_GY_yanshi]);
    display_ASCIIstring_6x12_right_align(5, 127, QY_yanshi[D_QY_yanshi]);
    display_ASCIIstring_6x12_right_align(7, 127, D3_DW[D3_Cur]);
    Lcd12864_Write12CnCHAR(0, 0, 0, ">");
    if (F_queren == 1)
    {
    ...
    clear_define_screen(0, 2, 82, 128);
    display_ASCIIstring_6x12_right_align(1, 127, SY_yanshi[(key_state & 0xFF)]);
...
void Fun_GT() // 过压延时
{
    ...
    clear_define_screen(2, 4, 82, 128);
    display_ASCIIstring_6x12_right_align(3, 127, GY_yanshi[(key_state & 0xFF)]);
    ...
    if ((key_value_tmp == 0x20) && (F_queren == 3))
    {
        ...
        clear_define_screen(2, 4, 82, 128);
        display_ASCIIstring_6x12_right_align(3, 127, GY_yanshi[D_SY_yanshi]);
        key_state = 0x3F100;
        F_queren = 1;
    }
}
...
void Fun_QT() // 欠压时间
{
    ...
    clear_define_screen(4, 6, 82, 128);
    display_ASCIIstring_6x12_right_align(5, 127, QY_yanshi[(key_state & 0xFF)]);
    ...
    if ((key_value_tmp == 0x20) && (F_queren == 3))
    {
        ...
        clear_define_screen(4, 6, 82, 128);
        display_ASCIIstring_6x12_right_align(3, 127, QY_yanshi[D_QY_yanshi]);
        key_state = 0x40100;
        F_queren = 1;
    }
}
...
void Fun_LD_hezha()
{
    ...
    //	LD_hezha=Array_LD[0];
    //	DY_hezha=Array_DY[0];
    Lcd12864_Write12CnCHAR(0, 0, 0, " D.上电合闸\r E.漏电合闸\r F.电压合闸\r G.电流合闸");
    display_graphic_6x12(1, 67, maohao);
    display_graphic_6x12(3, 67, maohao);
    display_graphic_6x12(5, 67, maohao);
    display_graphic_6x12(7, 67, maohao);
    Lcd12864_Write12CnCHAR(0, 0, 2, ">");
    display_kaiguan(1, 103, shangdian);
    display_kaiguan(3, 103, LD_hezha);
    display_kaiguan(5, 103, DY_hezha);
    display_kaiguan(7, 103, DL_hezha);
...
{
    clear_screen();
    Lcd12864_Write12CnCHAR(0, 0, 0, "9.欠压延时\r10.缺零保护\r11.电压重合\r12.缺零档位");
    display_graphic_6x12(1, 85, maohao);
    display_graphic_6x12(3, 85, maohao);
    display_graphic_6x12(5, 85, maohao);
    display_graphic_6x12(7, 85, maohao);
...
{
    clear_screen();
    Lcd12864_Write12CnCHAR(0, 0, 0, "13.缺零档位");
    display_graphic_6x12(1, 85, maohao);
...
void Fun_OP_Val() // 过流档位
{
    unsigned char array_tmp[3];
    clear_screen();
    Lcd12864_Write12CnCHAR(0, 0, 0, " 额定电流:\r 长延时时间:\r 短延时倍数:\r 短延时时间:");
    Lcd12864_Write12CnCHAR(0, 0, 0, ">");
    //    display_sanjiao(1,119,1,1);
    I_VAL_handle();
    xianshishuju_dianliu(SET_I_VAL);
    display_ASCIIstring_6x12_right_align(1, 127, zifu_dian);
    display_ASCIIstring_6x12_right_align(3, 127, GUOLIU_T[TH_Long_Cur]);
    display_ASCIIstring_6x12_right_align(5, 127, D2_DW[D2_Cur]);
    display_ASCIIstring_6x12_right_align(7, 127, D2_T[TH_DL]);
    if (F_queren == 1)
    {
        dianliu_dang = D_Cur;
    ...
    if ((key_value_tmp == 0x20) && (F_queren == 3))
    {
        ...
        Cur_Switch(Type_Cur);
        EEPROM_R(Addr_D_Cur, array_tmp, 2, 0xA0);
        clear_define_screen(0, 2, 93, 128);
        I_VAL_handle();
        delay_us(10);
        xianshishuju_dianliu(SET_I_VAL);
...
void Fun_OP_T() // 过流时间
{
    ...
    display_ASCIIstring_6x12_right_align(3, 127, GUOLIU_T[(key_state & 0xFF)]);
    if ((key_value_tmp == 0x20) && (F_queren == 3))
    {
...
void Fun_Delay_Val() // 短延档位
{
    ...
    display_ASCIIstring_6x12_right_align(5, 127, D2_DW[(key_state & 0xFF)]);
...
void Fun_Delay_T() // 短延时间
{
    ...
    display_ASCIIstring_6x12_right_align(7, 127, D2_T[(key_state & 0xFF)]);
...
void Fun_Instant_Val() // 瞬时档位
{
    ...
    clear_define_screen(6, 8, 82, 128);
    display_ASCIIstring_6x12_right_align(7, 127, D3_DW[(key_state & 0xFF)]);
...
{
    clear_screen();
    Lcd12864_Write12CnCHAR(0, 0, 0, "9.电流重合");
    display_graphic_6x12(1, 77, maohao);
...
void Fun_LS() // 记录查询
{
    ...
    {
        clear_screen();
        Lcd12864_Write12CnCHAR(0, 16, 0, "1.漏电设置\r  2电压设置\r  3电流设置\r  4记录查询");
    }
    else
    {
        clear_define_screen(0, 16, 91, 116);
...
{
    clear_screen(); // 清屏
    Lcd12864_Write12CnCHAR(0, 16, 0, "1历史记录\r  2跳闸次数\r");
    //    display_sanjiao(1,116,0,0);
    display_shouzhi(1, 95);
}
extern char xiangbie;
void Fun_Record_CX() // 记录查询内容
{
    ...
    {
        display_ASCIIstring_6x12(5, 60, " V");
    }
    else if (guzhang_wei == 2) // 漏电
    {

        display_ASCIIstring_6x12(5, 60, "mA");
    }
    else if (guzhang_wei == 3) // 过流“GL”
    {

        display_ASCIIstring_6x12(5, 60, " A");
    }
    else
    {
    ...
    if ((key_value_tmp == 0x80) || (key_value_tmp == 0x01)) // 向下键或者向上键
    {
        ...
        Lcd12864_Write12CnCHAR(0, 40, 2, guzhang_yuanyin[guzhang_wei]);
        Lcd12864_Write12CnCHAR(0, 72, 2, "分闸");

        Lcd12864_Write12CnCHAR(0, 0, 4, "参数:");
        display_ASCIIstring_6x12(5, 35, lishijilu_2);
        ...
        //				display_graphic_8x16(7,108,xiaomaohao);
        display_ASCIIstring_6x12(7, 108, miao);
        Lcd12864_Write12CnCHAR(0, 75, 4, "相别:");
        if (xiangbie == 1)
        {
        ...
        {
            Lcd12864_Write12CnCHAR(0, 110, 4, "无");
        }
    }

    Lcd12864_Write12CnCHAR(0, 0, 0, "近   次跳闸信息\r");
    display_ASCIIstring_6x12(1, 18, &lishijilu_1[2]);
    ...
    //				display_graphic_6x12(7,24,qirigang);
    //				display_ASCIIstring_6x12(7,29,yue);
    //				display_graphic_6x12(7,45,qirigang);
    //				display_ASCIIstring_6x12(7,50,ri);
    //
    //				display_graphic_6x12(7,65,xiaogang);
    //				display_ASCIIstring_6x12(7,71,shi);
    //				display_graphic_6x12(7,87,xiaomaohao);
    //				display_ASCIIstring_6x12(7,92,fen);
    //				display_graphic_6x12(7,108,xiaomaohao);
    //				display_ASCIIstring_6x12(7,113,miao);
}
...
void Fun_Shiyan_CX() // 记录查询内容
{
    ...
    if ((key_value_tmp == 0x80) || (key_value_tmp == 0x01)) // 向下键或者向上键
    {
        ...
        Lcd12864_Write12CnCHAR(0, 0, 0, "近   次试验信息\r");

        Lcd12864_Write12CnCHAR(0, 0, 2, "类型: ");

        Lcd12864_Write12CnCHAR(0, 0, 4, "结果:");
        ...
        {
            Lcd12864_Write12CnCHAR(0, 40, 2, "按键试跳");
        }
        else if (array_temps[7] == 0x0D)
        {
            Lcd12864_Write12CnCHAR(0, 40, 2, "远程试跳");
        }

        generate_chuan(ci, 0, 0, (N_Selftest) / 10, (N_Selftest) % 10);

        display_ASCIIstring_6x12(1, 16, &ci[2]);

        if (array_temps[0] == 0x11)
        {
            Lcd12864_Write12CnCHAR(0, 40, 4, "成功");
        }
        else
        {
            Lcd12864_Write12CnCHAR(0, 40, 4, "失败");
        }
    ...
    //	{
    //		clear_screen();
    //		Lcd12864_Write12CnCHAR(0,0,2,"无按键试跳记录");
    //	}
}
...
void Trip_Num_LOCK()
{
    ...
    // 显示总跳闸次数
    Lcd12864_Write12CnCHAR(0, 0, 0, "总跳闸:");
    display_ASCIIstring_6x12(1, 84, lishijilu_1);
    Lcd12864_Write12CnCHAR(0, 110, 0, "次");

    // 显示闭锁跳闸次数
    Lcd12864_Write12CnCHAR(0, 0, 2, "闭锁跳闸:");
    display_ASCIIstring_6x12(3, 84, lishijilu_bs);
    Lcd12864_Write12CnCHAR(0, 110, 2, "次");

    // 显示剩余电流跳闸次数
    Lcd12864_Write12CnCHAR(0, 0, 4, "剩余电流跳闸:");
    display_ASCIIstring_6x12(5, 84, lishijilu_lc);
    Lcd12864_Write12CnCHAR(0, 110, 4, "次");

    // 显示过电流跳闸次数
    Lcd12864_Write12CnCHAR(0, 0, 6, "过电流跳闸:");
    display_ASCIIstring_6x12(7, 84, lishijilu_oc);
    Lcd12864_Write12CnCHAR(0, 110, 6, "次");
}
...
void Trip_Num_LD() // 电压/电流跳闸次数
{
    ...
    // 显示总跳闸次数
    Lcd12864_Write12CnCHAR(0, 0, 0, "数据清零:");
    display_ASCIIstring_6x12(1, 84, lishijilu_1);
    Lcd12864_Write12CnCHAR(0, 110, 0, "次");

    // 显示闭锁跳闸次数
    Lcd12864_Write12CnCHAR(0, 0, 2, "过压跳闸:");
    display_ASCIIstring_6x12(3, 84, lishijilu_2);
    Lcd12864_Write12CnCHAR(0, 110, 2, "次");

    // 显示剩余电流跳闸次数
    Lcd12864_Write12CnCHAR(0, 0, 4, "欠压跳闸:");
    display_ASCIIstring_6x12(5, 84, lishijilu_bs);
    Lcd12864_Write12CnCHAR(0, 110, 4, "次");

    // 显示过电流跳闸次数
    Lcd12864_Write12CnCHAR(0, 0, 6, "缺相跳闸:");
    display_ASCIIstring_6x12(7, 84, lishijilu_lc);
    Lcd12864_Write12CnCHAR(0, 110, 6, "次");

    //		clear_screen();
    //	Lcd12864_Write12CnCHAR(0,0,0,"3 闭锁跳闸次数\r         次");
    //		Lcd12864_Write12CnCHAR(0,0,4,"4 漏电跳闸次数\r         次");
...
void Trip_Num_DY() // 上电/缺零跳闸次数
{
    ...
    // 显示总跳闸次数
    Lcd12864_Write12CnCHAR(0, 0, 0, "短延跳闸:");
    display_ASCIIstring_6x12(1, 84, lishijilu_1);
    Lcd12864_Write12CnCHAR(0, 110, 0, "次");

    // 显示闭锁跳闸次数
    Lcd12864_Write12CnCHAR(0, 0, 2, "短瞬跳闸:");
    display_ASCIIstring_6x12(3, 84, lishijilu_2);
    Lcd12864_Write12CnCHAR(0, 110, 2, "次");

    // 显示剩余电流跳闸次数
    Lcd12864_Write12CnCHAR(0, 0, 4, "手动跳闸:");
    display_ASCIIstring_6x12(5, 84, lishijilu_bs);
    Lcd12864_Write12CnCHAR(0, 110, 4, "次");

    // 显示过电流跳闸次数
    Lcd12864_Write12CnCHAR(0, 0, 6, "按键跳闸:");
    display_ASCIIstring_6x12(7, 84, lishijilu_lc);
    Lcd12864_Write12CnCHAR(0, 110, 6, "次");
    //	clear_screen();
    //	Lcd12864_Write12CnCHAR(0,0,0,"5 电流跳闸次数\r         次");
    //		Lcd12864_Write12CnCHAR(0,0,4,"6 过压跳闸次数\r         次");
    //		display_ASCIIstring_8x16(3,39,lishijilu_1);
    //	display_ASCIIstring_8x16(7,39,lishijilu_2);
}
...
{
    // clear_screen();
    // Lcd12864_Write12CnCHAR(0,0,0,"7 手动闭锁跳闸次数\r         次");
    //		Lcd12864_Write12CnCHAR(0,0,4,"8 按键跳闸次数\r         次");////2022.2.22发现此处应该由试验跳闸改为按键跳闸
    //		display_ASCIIstring_8x16(3,39,lishijilu_1);
    //	display_ASCIIstring_8x16(7,39,lishijilu_2);
}
...
{
    // clear_screen();
    //      Lcd12864_Write12CnCHAR(0,0,0,"9 短延跳闸次数\r         次");
    //		Lcd12864_Write12CnCHAR(0,0,4,"10短瞬跳闸次数\r         次");
    //		display_ASCIIstring_8x16(3,39,lishijilu_1);
    //	display_ASCIIstring_8x16(7,39,lishijilu_2);
}
...
{
    // clear_screen();
    // Lcd12864_Write12CnCHAR(0,0,0,"11欠压跳闸次数\r         次");
    //		Lcd12864_Write12CnCHAR(0,0,4,"12缺相跳闸次数\r         次");
    //		display_ASCIIstring_8x16(3,39,lishijilu_1);
    //	display_ASCIIstring_8x16(7,39,lishijilu_2);
}
void Fun_Time() // 时间设置
{
    ...
    //		{
    //			clear_screen();
    Lcd12864_Write12CnCHAR(0, 16, 0, "5时间设置\r  6系统设置\r  7校准设置");
    //		}
    //		else
    //		{
    //		 clear_define_screen(0,16,91,116);
...
void Fun_Time_Y() // 时间设置-年
{
    ...
    clear_screen();
    Lcd12864_Write12CnCHAR(0, 0, 0, " 通信速率:\r 壳架设置:");

    display_ASCIIstring_6x12_right_align(1, 127, botelv[baud]);
    Disp_date();
    Disp_time();
    if (Type_cur_Temp == 0)
    {
        display_ASCIIstring_6x12_right_align(3, 127, "125A");
    }
    if (Type_cur_Temp == 1)
    {
        display_ASCIIstring_6x12_right_align(3, 127, "250A");
    }
    else if (Type_cur_Temp == 2)
    {
        display_ASCIIstring_6x12_right_align(3, 127, "400A");
    }
    else if (Type_cur_Temp == 3)
    {
        display_ASCIIstring_6x12_right_align(3, 127, "630A");
    }
    else if (Type_cur_Temp == 4)
    {
        display_ASCIIstring_6x12_right_align(3, 127, "800A");
    }
    Lcd12864_Write12CnCHAR(0, 0, 4, ">");
    display_ASCIIstring_6x12_with_underline(5, 76, nian);
    RTC_Readtime();
    if (F_queren == 1)
    {
...
void Fun_Time_M() // 月
{
    ...
    display_ASCIIstring_6x12_with_underline(5, 96, yue);
    Lcd12864_Write12CnCHAR(0, 0, 4, ">");
    RTC_Readtime();
    if (F_queren == 1)
    {
...
void Fun_Time_D() // 日
{
    ...
    Disp_Write_time();
    display_ASCIIstring_6x12_with_underline(5, 113, ri);
    if ((key_value_tmp == 0x20) && (F_queren == 3))
    {
        RTC_Set_Time(tim_h3, tim_f3, tim_s3);
        RTC_Set_Date(tim_y3, tim_m3, tim_d3);
...
void Fun_Time_H() // 时
{
    ...
    Disp_Write_time();
    display_ASCIIstring_6x12_with_underline(7, 71, shi);
    if ((key_value_tmp == 0x20) && (F_queren == 3))
    {
        RTC_Set_Time(tim_h3, tim_f3, tim_s3);
        RTC_Set_Date(tim_y3, tim_m3, tim_d3);
...
void Fun_Time_F() // 分
{
    ...
    Disp_Write_time();
    display_ASCIIstring_6x12_with_underline(7, 89, fen);
...
void Fun_Time_S() // 秒
{
    ...
    Disp_Write_time();
    display_ASCIIstring_6x12_with_underline(7, 108, miao);
    if ((key_value_tmp == 0x20) && (F_queren == 3))
    {
        RTC_Set_Time(tim_h3, tim_f3, tim_s3);
        RTC_Set_Date(tim_y3, tim_m3, tim_d3);
...
void Fun_TD_fenzha() // 停电分闸
{
    //    clear_screen();
    //	   unsigned char array_tmp[3];
    //	  Lcd12864_Write12CnCHAR(0,0,0,"13校准档位\r14缺零保护");
    //		display_graphic_6x12(1,94,maohao);
    //		display_graphic_6x12(3,94,maohao);
    //		display_graphic_6x12(5,94,maohao);
    //
...
void Fun_Com_S() // 通信速率
{
    ...
    display_ASCIIstring_6x12_right_align(1, 127, botelv[(key_state & 0xFF)]);
...
void Fun_Com_D_1() // 通信地址第1位
{
    ...
    add_6_1[1] = '\0';
    display_ASCIIstring_6x12_with_underline(5, 56, add_6_1);
...
void Fun_Com_D_2()
{
    ...
    display_ASCIIstring_6x12_with_underline(5, 62, add_6_2);
    display_ASCIIstring_6x12(5, 68, add_5_1);
    display_ASCIIstring_6x12(5, 74, add_5_2);
    display_ASCIIstring_6x12(5, 80, add_4_1);
    display_ASCIIstring_6x12(5, 86, add_4_2);
...
void Fun_Com_D_3()
{
    ...
    display_ASCIIstring_6x12(5, 56, add_6_1);
    display_ASCIIstring_6x12(5, 62, add_6_2);
    display_ASCIIstring_6x12_with_underline(5, 68, add_5_1);
    display_ASCIIstring_6x12(5, 74, add_5_2);
    display_ASCIIstring_6x12(5, 80, add_4_1);
    display_ASCIIstring_6x12(5, 86, add_4_2);
    display_ASCIIstring_6x12(5, 92, add_3_1);
...
void Fun_Com_D_4()
{
    ...
    display_ASCIIstring_6x12(5, 62, add_6_2);
    display_ASCIIstring_6x12(5, 68, add_5_1);
    display_ASCIIstring_6x12_with_underline(5, 74, add_5_2);
    display_ASCIIstring_6x12(5, 80, add_4_1);
    display_ASCIIstring_6x12(5, 86, add_4_2);
    display_ASCIIstring_6x12(5, 92, add_3_1);
    display_ASCIIstring_6x12(5, 98, add_3_2);
...
void Fun_Com_D_5()
{
    ...
    display_ASCIIstring_6x12(5, 68, add_5_1);
    display_ASCIIstring_6x12(5, 74, add_5_2);
    display_ASCIIstring_6x12_with_underline(5, 80, add_4_1);
    display_ASCIIstring_6x12(5, 86, add_4_2);
    display_ASCIIstring_6x12(5, 92, add_3_1);
    display_ASCIIstring_6x12(5, 98, add_3_2);
    display_ASCIIstring_6x12(5, 104, add_2_1);
...
void Fun_Com_D_6()
{
    ...
    display_ASCIIstring_6x12(5, 74, add_5_2);
    display_ASCIIstring_6x12(5, 80, add_4_1);
    display_ASCIIstring_6x12_with_underline(5, 86, add_4_2);
    display_ASCIIstring_6x12(5, 92, add_3_1);
    display_ASCIIstring_6x12(5, 98, add_3_2);
    display_ASCIIstring_6x12(5, 104, add_2_1);
    display_ASCIIstring_6x12(5, 110, add_2_2);
...
void Fun_Com_D_7()
{
    ...
    display_ASCIIstring_6x12(5, 80, add_4_1);
    display_ASCIIstring_6x12(5, 86, add_4_2);
    display_ASCIIstring_6x12_with_underline(5, 92, add_3_1);
    display_ASCIIstring_6x12(5, 98, add_3_2);
    display_ASCIIstring_6x12(5, 104, add_2_1);
    display_ASCIIstring_6x12(5, 110, add_2_2);
    display_ASCIIstring_6x12(5, 116, add_1_1);
...
void Fun_Com_D_8()
{
    ...
    display_ASCIIstring_6x12(5, 86, add_4_2);
    display_ASCIIstring_6x12(5, 92, add_3_1);
    display_ASCIIstring_6x12_with_underline(5, 98, add_3_2);
    display_ASCIIstring_6x12(5, 104, add_2_1);
    display_ASCIIstring_6x12(5, 110, add_2_2);
    display_ASCIIstring_6x12(5, 116, add_1_1);
    display_ASCIIstring_6x12(5, 122, add_1_2);
...
void Fun_Com_D_9()
{
    ...
    display_ASCIIstring_6x12(5, 92, add_3_1);
    display_ASCIIstring_6x12(5, 98, add_3_2);
    display_ASCIIstring_6x12_with_underline(5, 104, add_2_1);
    display_ASCIIstring_6x12(5, 110, add_2_2);
    display_ASCIIstring_6x12(5, 116, add_1_1);
    display_ASCIIstring_6x12(5, 122, add_1_2);
    Lcd12864_Write12CnCHAR(0, 76, 6, External_GateMode[External_Gate_Control_Flag]);
...
void Fun_Com_D_10()
{
    ...
    display_ASCIIstring_6x12(5, 98, add_3_2);
    display_ASCIIstring_6x12(5, 104, add_2_1);
    display_ASCIIstring_6x12_with_underline(5, 110, add_2_2);
    display_ASCIIstring_6x12(5, 116, add_1_1);
    display_ASCIIstring_6x12(5, 122, add_1_2);
    Lcd12864_Write12CnCHAR(0, 76, 6, External_GateMode[External_Gate_Control_Flag]);
...
void Fun_Com_D_11()
{
    ...
    display_ASCIIstring_6x12(5, 104, add_2_1);
    display_ASCIIstring_6x12(5, 110, add_2_2);
    display_ASCIIstring_6x12_with_underline(5, 116, add_1_1);
    display_ASCIIstring_6x12(5, 122, add_1_2);
    Lcd12864_Write12CnCHAR(0, 76, 6, External_GateMode[External_Gate_Control_Flag]);
...
void Fun_Com_D_12()
{
    ...
    display_ASCIIstring_6x12(5, 110, add_2_2);
    display_ASCIIstring_6x12(5, 116, add_1_1);
    display_ASCIIstring_6x12_with_underline(5, 122, add_1_2);
    Lcd12864_Write12CnCHAR(0, 76, 6, External_GateMode[External_Gate_Control_Flag]);
...
void Fun_External_GateMode(void)
{
    clear_screen();
    unsigned char mima0[2], mima1[2], mima2[2], mima3[2];
    unsigned char array_tmp[3];
    ...
    if (F_queren == 1)
    {
        key_state = key_state | External_Gate_Control_Flag;
    }
    if ((key_value_tmp == 0x20) && (F_queren < 3))
    {
        F_queren++;
    }
    clear_define_screen(6, 8, 76, 128);
    Lcd12864_Write12CnCHAR(0, 76, 6, External_GateMode[key_state & 0xff]);
    if ((key_value_tmp == 0x20) && (F_queren == 3))
    {

        External_Gate_Control_Flag = key_state & 0xff;
        Lcd12864_Write12CnCHAR(0, 76, 6, External_GateMode[External_Gate_Control_Flag]);
        array_tmp[0] = External_Gate_Control_Flag;
        MODIFY_EEP_W(External_Gate_Control_Flag_Addr, array_tmp, 1, 0xA0);
        key_state = 0x21100;
        F_queren = 1;
    }
}
...
void Time_Hezha_delay()
{
    ...
    display_ASCIIstring_6x12_right_align(1, 127, hezha_delay_show[(key_state & 0xFF)]);
...
void Fun_Corr_Slec()
{
    ...
    display_graphic_6x12(3, 94, maohao);
    display_graphic_6x12(5, 94, maohao);
    display_graphic_6x12(7, 94, maohao);
